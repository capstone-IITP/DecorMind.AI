...
import KitchenCarousel from './_components/KitchenCarousel';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white" id="top">
      ...
      {/* Kitchen Design Showcase Section */}
      <div id="kitchen-showcase" className="py-16 bg-zinc-900">
        <div className="container mx-auto px-6">
          <KitchenCarousel 
            onSeeMoreClick={() => {
              event({
                action: 'see_more_kitchen_designs',
                category: 'homepage',
                label: 'kitchen_designs_button'
              });
              router.push('/kitchen-designs');
            }}
          />
        </div>
      </div>
